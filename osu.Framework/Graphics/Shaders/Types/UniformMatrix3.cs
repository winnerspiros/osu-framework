...
namespace osu.Framework.Graphics.Shaders.Types
{
    ...
    public record struct UniformMatrix3
    {
        ...
        {
            Row0 = new System.Numerics.Vector3(matrix.M11, matrix.M12, 0),
            Row1 = new System.Numerics.Vector3(matrix.M21, matrix.M22, 0),
            Row2 = new System.Numerics.Vector3(matrix.M31, matrix.M32, 1)
        };
    }
}
